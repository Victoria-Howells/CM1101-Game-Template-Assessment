...
def normalise_input(user_input):
    ...
    'help'
    """
    new_input1 = remove_punct(user_input)
    new_input2 = remove_spaces(new_input1)
    new_input3 = new_input2.lower()
    return new_input3
...
def menu(exits):
    ...
    while True:
        ...
        # Normalise the input
        new_user_input = normalise_input(user_input)
        # Check if the input makes sense (is valid exit)
            # If so, return the player's choice
        if is_valid_exit(exits, new_user_input) == True:
